    ...
    <div className="offer">
      <div className="container">
        <div className="row offer__info justify-content-md-center">
          ...
          <div className="offer__text col-12 col-md-4">
            <p>
              La región carecía de una oferta gastronómica de nivel
              internacional. Es por eso que decidimos combinar materia prima
              regional de calidad con la mejor cocina, cava y coctelería en un
              espacio arquitectónico único, atendiendo a la trazabilidad y
              sustentabilidad de nuestros procesos.
            </p>
      ...
      <div className="offer__cards">
        ...
        <div className="card">
          ...
          <p className="card__text">
            Contamos con una colección de los mejores vinos de la Argentina para
            todos los gustos.
          </p>
        </div>
        <div className="card">
